...
namespace Hobby_Project
{
    public class Hobby : BaseEntity, IPrint
    {
        ...
        public Hobby(string title, string description, HobbySubCategory hobbySubCategory, List<HobbyComment> comments, List<Tag> tags)
        {
            Title = title;
        ...
        public void RemoveComment(HobbyComment hobbyComment) => this.Comments.Remove(hobbyComment);
